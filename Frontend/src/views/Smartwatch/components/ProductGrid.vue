...
const fetchProducts = async () => {
  loading.value = true
  try {
    // Category name for smartwatch based on previous patterns
    const data = await getProducts({ ...props.filters, category: 'smartwatch' })
...
<template>
  <div class="flex-1 w-full">
    ...
    <div class="flex justify-between items-center mb-6 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
      <h1 class="text-xl font-bold text-gray-900">Smartwatches</h1>
